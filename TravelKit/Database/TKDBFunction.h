...
TK_ALWAYS_INLINE TKDBValueType TKDBValueGetType(TKDBValueRef value) {
    return (TKDBValueType)sqlite3_value_type(value);
}

TK_ALWAYS_INLINE const void * TKDBValueGetBlob(TKDBValueRef value) {
    return sqlite3_value_blob(value);
}

TK_ALWAYS_INLINE int TKDBValueGetBytes(TKDBValueRef value) {
    return sqlite3_value_bytes(value);
}

TK_ALWAYS_INLINE double TKDBValueGetDouble(TKDBValueRef value) {
    return sqlite3_value_double(value);
}

TK_ALWAYS_INLINE int64_t TKDBValueGetInt64(TKDBValueRef value) {
    return sqlite3_value_int64(value);
}

TK_ALWAYS_INLINE const char* TKDBValueGetText(TKDBValueRef value) {
 ...
 */
TK_ALWAYS_INLINE void* TKDBContextGetInfo(TKDBContextRef context) {
 ...
 */
TK_ALWAYS_INLINE void TKDBContextResultError(TKDBContextRef context, const char *name, int code) {
    sqlite3_result_error(context, name, code);
}

TK_ALWAYS_INLINE void TKDBContextResultBlob(TKDBContextRef context, const void* blob, uint64_t bytes) {
    sqlite3_result_blob64(context, blob, bytes, SQLITE_TRANSIENT);
}

TK_ALWAYS_INLINE void TKDBContextResultConstBlob(TKDBContextRef context, const void* blob, uint64_t bytes) {
    sqlite3_result_blob64(context, blob, bytes, SQLITE_STATIC);
}

TK_ALWAYS_INLINE void TKDBContextResultDouble(TKDBContextRef context, double val) {
    sqlite3_result_double(context, val);
}

TK_ALWAYS_INLINE void TKDBContextResultInt(TKDBContextRef context, int val) {
    sqlite3_result_int(context, val);
}

TK_ALWAYS_INLINE void TKDBContextResultInt64(TKDBContextRef context, int64_t val) {
    sqlite3_result_int64(context, val);
}

TK_ALWAYS_INLINE void TKDBContextResultText(TKDBContextRef context, const char* text, uint64_t bytes) {
    sqlite3_result_text64(context, text, bytes, SQLITE_TRANSIENT, SQLITE_UTF8);
}

TK_ALWAYS_INLINE void TKDBContextResultConstText(TKDBContextRef context, const char* text, uint64_t bytes) {
    sqlite3_result_text64(context, text, bytes, SQLITE_STATIC, SQLITE_UTF8);
}

TK_ALWAYS_INLINE void TKDBContextResultNull(TKDBContextRef context) {

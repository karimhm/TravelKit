...
- (NSString*)description {
    return [NSString stringWithFormat:@"<%@: %p; id: %@; name: %@, days: %i>", [self class], self, [NSString stringWithUTF8String:IID(self.identifier).stringID().c_str()], self.name, self.days];
}
#endif
